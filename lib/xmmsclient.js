...
(function() {
  var ActivePlaylist, Bindata, Client, Collection, CollectionChanged, CollectionNamespace, Error, MediainfoReaderStatus, MedialibEntryStatus, Message, PlaybackStatus, PlaylistChange, PlaylistPositionAction, PluginType, PropDict, Result, Seek, Util, Value, net, url, xmmsclient,
  ...
  Value = (function() {
    ...
    Value.deserialize = function(bindata, type) {
  ...
  Client = (function() {
    ...
    Client.prototype.protocol_version = 24;
